  ...
  return (
    <section ref={ref} className="py-32 bg-luxury-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-12 gap-8">
              ...
              {steps.map((step, index) => (
                ...
                >
                  <div className="flex items-start space-x-6">
                    {/* Step number */}
                    <div className={`font-display text-2xl tracking-wider transition-all duration-300 ${
                    ...
                    <div className="flex-1">
                      <h4 className={`font-serif text-xl mb-2 transition-all duration-300 ${
                        activeStep === index ? 'text-luxury-black' : 'text-luxury-gray-600'
                      }`}>
                        {step.title}
                      </h4>
                      <p className="font-display text-xs tracking-widest uppercase text-luxury-gray-400 mb-3">
                        {step.subtitle}
                      </p>
          ...
          >
            <div className="relative">
              ...
              >
                <h4 className="font-serif text-3xl font-light text-luxury-black mb-6">
                  {steps[activeStep].title}
                </h4>
                
                <p className="font-serif text-lg leading-relaxed text-luxury-gray-700 mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {steps[activeStep].details.map((detail, index) => (
                    <div key={index} className="group">
                      <div className="w-6 h-px bg-luxury-black mb-3 group-hover:w-12 transition-all duration-300" />
                      <p className="font-display text-sm tracking-wider uppercase text-luxury-gray-600">
                        {detail}
                      </p>
                    </div>
                  ))}
        ...
        >
          <blockquote className="font-serif text-2xl md:text-3xl italic font-light text-luxury-gray-600 max-w-4xl mx-auto">
          ...
          <div className="w-16 h-px bg-luxury-black mx-auto mt-8" />
        </motion.div>
      </div>
    </section>
  )

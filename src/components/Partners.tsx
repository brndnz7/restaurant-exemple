    ...
    <section className="py-32 bg-luxury-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {partners.map((partner, index) => (
            ...
            >
              ...
              <div className="flex items-start space-x-6 mb-6">
                <div className="bg-luxury-gray-100 p-4 text-luxury-black group-hover:bg-luxury-black group-hover:text-luxury-white transition-colors duration-300">
                  {partner.icon}
                </div>
                
                <div className="flex-1">
                  <h4 className="font-serif text-2xl font-light text-luxury-black mb-2">
                    {partner.name}
                  </h4>
                  <div className="flex items-center space-x-3 mb-2">
                    <MapPin className="w-4 h-4 text-luxury-gray-400" />
              ...
              <div className="border-l-2 border-luxury-gray-200 pl-6 group-hover:border-luxury-black transition-colors duration-300">
                <p className="font-serif text-lg leading-relaxed text-luxury-gray-700 mb-4">
                  {partner.description}
                </p>
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-px bg-luxury-black" />
        ...
        >
          ...
          <blockquote className="font-serif text-2xl md:text-3xl italic font-light text-luxury-gray-600 max-w-4xl mx-auto mb-8">
          ...
          <cite className="font-display text-sm tracking-wider uppercase text-luxury-gray-500">
        ...
        >
          <div>
            <div className="font-serif text-6xl font-light text-luxury-black mb-4">25</div>
            <div className="w-16 h-px bg-luxury-black mx-auto mb-4" />
            <p className="font-display text-sm tracking-widest uppercase text-luxury-gray-500">
              Producteurs Partenaires
            </p>
          </div>
          
          <div>
            <div className="font-serif text-6xl font-light text-luxury-black mb-4">100%</div>
            <div className="w-16 h-px bg-luxury-black mx-auto mb-4" />
            <p className="font-display text-sm tracking-widest uppercase text-luxury-gray-500">
              Produits Français
            </p>
          ...
          <div>
            <div className="font-serif text-6xl font-light text-luxury-black mb-4">15</div>
            <div className="w-16 h-px bg-luxury-black mx-auto mb-4" />
            <p className="font-display text-sm tracking-widest uppercase text-luxury-gray-500">
